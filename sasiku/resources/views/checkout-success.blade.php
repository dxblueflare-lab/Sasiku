@extends('layouts.home', ['title' => 'Pesanan Berhasil | SASIKU'])
...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
    <div class="text-center mb-12">
        ...
        <p class="text-gray-600">Terima kasih telah berbelanja di SASIKU</p>
    </div>

    <!-- Order Details -->
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mb-8">
        <div class="p-6 bg-gradient-to-r from-violet-500 to-pink-500 text-white">
    ...
    <div class="flex flex-col sm:flex-row justify-center gap-4">
        <a href="{{ route('payment', $order) }}" class="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-xl font-semibold hover:shadow-lg transition-all">
        ...
        <a href="{{ route('home') }}" class="inline-flex items-center justify-center px-6 py-3 bg-white border border-gray-200 rounded-xl font-medium hover:bg-gray-50 transition-colors">
